...
module.exports = function(schema, options) {
    ...
    options.noSaltValueStored = options.noSaltValueStored || 'User cannot be logged in. No salt value stored in mongodb';
    ...
    schema.methods.authenticate = function(password, cb) {
        ...
        if (!this.get(options.saltField)) {
            return cb(null, false, { message: options.noSaltValueStored });
        }
