...
module.exports = function(schema, options) {
    ...
    schema.methods.authenticate = function(password, cb) {
        ...
        //Added optional validate function for verify another parameters before login (example a activation require
		if (options.validateFunction)
			if(!options.validateFunction(self)
				return cb(null, false, { message: options.validateError });
